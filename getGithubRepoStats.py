    ...
    try:
        ...
        while contents:
            ...
            if file_content.type == "file":
                ...
                if (
                    file_content.name.lower().startswith("readme")
                    or file_content.name == ".gitignore"
                    or file_content.name == "rewards.json"
                ):
                    continue
                if (
                    file_content.name == "requirements.txt"
                    or file_content.name == "Procfile"
                    or file_content.name == "runtime.txt"
                ):
                    continue
...
# Example usage:
owner = "404-5971"  # Replace with the owner of the repository
...
print(
    f"Omniplexium-Eternal: {omniEternalTotalFiles} files, {omniEternalTotalLines} lines"
)
